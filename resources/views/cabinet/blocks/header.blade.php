    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto mt-md-0">
                ...
                <li class="nav-item dropdown mega-menu"> <a class="nav-link dropdown-toggle text-muted  " href="index1.html#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ti-wallet m-r-5"></i> Wallet</a>
                        ...
                        <ul class="mega-menu-menu row">
                            <li class="col-lg-3  m-b-30">
                                ...
                                <ul class="list-style-none">
                                    <li><a href="index1.html#"><i class="cc BTC"></i> Bitcoin Transaction</a></li>
                                    <li><a href="index1.html#"><i class="cc BTC"></i> Bitcoin Transaction</a></li>
                                    <li><a href="index1.html#"><i class="cc BTC"></i> Bitcoin Transaction</a></li>
                                    <li><a href="index1.html#"><i class="cc BTC"></i> Bitcoin Transaction</a></li>
                                    <li><a href="index1.html#"><i class="cc BTC"></i> Bitcoin Transaction</a></li>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted text-muted  " href="index1.html#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-bell"></i>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted  " href="index1.html#" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-envelope"></i>
                        <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                    </a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted  " href="index1.html#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i></a>
                    <div class="dropdown-menu dropdown-menu-right animated slideInRight">
                        <ul class="dropdown-user">
                            <li role="separator" class="divider"></li>
                            <li><a href="index1.html#"> Profile</a></li>
                            <li><a href="index1.html#"> Balance</a></li>
                            <li><a href="index1.html#"> Inbox</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="index1.html#"> Setting</a></li>
                            <li role="separator" class="divider"></li>
